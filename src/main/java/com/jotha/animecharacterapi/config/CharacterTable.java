...
public class CharacterTable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String tableName = "tb_AnimeCharacter";

        try {
            System.out.println("Criando tabela, aguarde...");
            Table table = dynamoDB.createTable(tableName, Arrays.asList(new KeySchemaElement("id", KeyType.HASH)), Arrays.asList(new AttributeDefinition("id", ScalarAttributeType.S)), new ProvisionedThroughput(5L, 5L));
            table.waitForActive();
